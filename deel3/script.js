...
function instruction9() {
    ...
    links.addEventListener('click', function(){ alert("Naar links");  });
...
function instruction10() {
    ...
    var str = "Mediacollege Amsterdam" ;
    var n = str.length;
    var s = " " + str.substr(1, n);
    var b = s.substr(1, n);
    var bl= b.length;
    var result = " " ;
    var woorden = str.split(" ").length;
    result += "De string waar de bewerkingen op gedaan worden is:" + str +" <br>";
    result += "De lengte van de string is: " + n + "<br>";
    result += "De eerste letters is vervangen door een spatie: " + s + " <br>";
    result += "De lengte van de string is nog steeds: " + n + "<br>";
    result += "Alle spaties aan het begin en eind zijn nu verwijderd: " + b +" <br>";
    result += "De lengte van de string is nu: " + bl + "<br>";
    result += "Het aantal woorden is: " + woorden + "<br>";
    result += "Het eerste woord is: " + str.split(" ")[0] + "<br>";
    result += "Het tweede woord is: " + str.split(" ")[1] + "<br>";
...
function instruction11() {
    ...
    try {
        ...
        //send error messege to server
        document.body.innerHTML = "// a error";
        alert("A error :/")
    } finally {
        alert("done");
    }
