...
function instruction7(){
	...
	function instruction7a(){
		...
		if(current_day == 1){current_day = "Maandag";}
		if(current_day == 2){current_day = "Dinsdag";}
		if(current_day == 3){current_day = "Woensdag";}
		if(current_day == 4){current_day = "Donderdag";}
		if(current_day == 5){current_day = "Vrijdag";}
		if(current_day == 6){current_day = "Zaterdag";}
		if(current_day == 0){current_day = "Zondag";}
